...
We started with the capacitor C = 100 nF. But we still got some bounces. We increased it gradually, to 150, 220, 330, and now 470 nF. The time response from a human perspective was still acceptable. It was an experimental, incremental exercise.
